<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href= "{{ asset('back-end/plugins/font-awesome/css/font-awesome.min.css')}}">
  <!-- Ionicons -->
  ...
  <link rel="stylesheet" href="{{ asset('back-end/css/skins/_all-skins.min.css')}}">
